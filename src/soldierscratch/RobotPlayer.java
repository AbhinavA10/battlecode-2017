/*I added the code into the soldier function
* added break; in dodge()*/

/*In the team array:
* 0, 1, 2, and 3 are used for furthest points
* 5, and 6 are used for max Scouts and Gardeners
            ...
            try {
                ...
                for (RobotInfo enemy : enemies) {
                    ...
                    if (rc.canFireSingleShot()) {
                        rc.fireSingleShot(myLocation.directionTo(enemy.location));
                    } else if (!rc.hasMoved()) {
                        tryMove(myLocation.directionTo(enemy.location));
                        break;
                    }
                }
